...
public interface InternalNotificationGateway {
    ...
    void notifyTeamLeadOfWorkInsightRework(UUID reviewerUserId, UUID teamLeadUserId, String message);
    void notifyRoleDepartmentChangeApprover(UUID requesterUserId, String requesterRole,
                                            UUID targetDepartmentId, String message);
    void notifyRoleDepartmentChangeDecision(UUID approverUserId, UUID requesterUserId, String message);
    ...
    void notifyAccountClosureReview(UUID requesterUserId, String targetRole, UUID departmentId, String message);
