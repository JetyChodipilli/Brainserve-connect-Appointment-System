...
public class WorkTaskAuditRecord extends AuditableEntity {
    ...
    private WorkInsightStatus auditStatus = WorkInsightStatus.PENDING_CEO_APPROVAL;
    ...
    public void decide(UUID ceoUserId, boolean approved, String remarks) {
        if (auditStatus != WorkInsightStatus.PENDING_CEO_APPROVAL) {
            throw new BusinessException("WORK_INSIGHT_ALREADY_DECIDED",
                    "This weekly work audit already has a CEO decision", HttpStatus.CONFLICT);
        }
